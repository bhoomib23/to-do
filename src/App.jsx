    ...
    <>
      ...
      <h1 className="font-bold text-center text-2xl">iTask -Manage your tasks at one place</h1>
        <div className="addtodo my-5 flex flex-col gap-4">
          ...
          <button onClick={handleadd} disabled={todo.length === 0} className="bg-red-200 hover:bg-red-300  mx-2 p-4 py-2 text-sm disabled:opacity-50 font-bold text-white rounded-full"> Save </button>
          </div>
        </div>
